...
},{"./converter":12,"./reverter":13}],4:[function(require,module,exports){
'use strict';
...
exports.commands = new Map([['A', {
	...
	handler: function handler(p) {// TODO
	...
	parameters: '',
	handler: function handler(p) {
		// ^GBw,h,t,c,r : t: border thickness, c: line color, r: degree of corner-rounding	
		var obj = {};
		obj.type = 'rect';
	...
	parameters: '',
	handler: function handler(p) {
		// Graphic Diagonal Line ^GDw,h,t,c,o
		var obj = {};
		obj.type = 'line';
		obj.width = parseInt(p[0]);
		obj.height = parseInt(p[1]);
	...
	desc: '^GFa,b,c,d,data',
	parameters: '',
	handler: function handler(p) {// ^GFa,b,c,d,data : a: compression type(A,B,C), b: binary byte count, c: graphic field count, d: bytes per row
		// Graphic Field 지원 안함.
	}
}], ['GS', {
	desc: '',
	parameters: '',
	handler: function handler(p) {// ^GSo,h,w
...
exports.Line = line;
},{"./rect":10}],10:[function(require,module,exports){
'use strict';
...
},{"./components/commands":5}],13:[function(require,module,exports){
'use strict';
...
},{"./components/barcode":4,"./components/ellipse":6,"./components/group":7,"./components/image":8,"./components/line":9,"./components/rect":10,"./components/text":11}]},{},[2]);
